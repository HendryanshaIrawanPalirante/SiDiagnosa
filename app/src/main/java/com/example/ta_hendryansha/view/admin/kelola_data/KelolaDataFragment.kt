...
import com.example.ta_hendryansha.data.menu.DataMenuKelolaData
...
class KelolaDataFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_kelola_data, container, false)
    }
    ...
    fun setInitLayout(view: View){
        ...
        rvMenu.layoutManager = GridLayoutManager(requireContext(), 2, RecyclerView.VERTICAL, false)
        rvMenu.setHasFixedSize(true)
    }

    fun setMenu(){
        listMenu.addAll(DataMenuKelolaData.dataMenu())
